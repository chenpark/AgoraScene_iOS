...
public class VRDisclaimerViewController: VRBaseViewController,UITextViewDelegate {
    ...
    let attributeText = NSAttributedString {
        AttributedText(LanguageManager.localValue(key: "[Agora Chat Room Demo]")).font(.systemFont(ofSize: 16, weight: .semibold)).foregroundColor(Color(0x040925)).lineSpacing(6)
        ...
        Link("support@agora.io", url: URL(string: "mailto:support@agora.io")!).foregroundColor(Color(0x1561f3)).lineSpacing(6).font(.systemFont(ofSize: 16, weight: .regular))
