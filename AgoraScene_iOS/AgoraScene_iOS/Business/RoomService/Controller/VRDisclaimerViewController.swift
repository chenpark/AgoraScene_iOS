...
public class VRDisclaimerViewController: VRBaseViewController,UITextViewDelegate {
    ...
    let attributeText = NSAttributedString {
        AttributedText("[Agora Chat Room Demo]").font(.systemFont(ofSize: 16, weight: .semibold)).foregroundColor(Color(0x040925)).lineSpacing(6)
        ...
        AttributedText("If you have any query, please feel free to contact").font(.systemFont(ofSize: 16, weight: .regular)).lineSpacing(6).foregroundColor(Color(0x040925))
        Link("support@agora.io", url: URL(string: "mailto:support@agora.io")!).foregroundColor(Color(0x1561f3)).lineSpacing(6)
